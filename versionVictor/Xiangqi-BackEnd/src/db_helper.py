...
#---ranking query (siempre agrupar si se utiliza count)
...
#showTGSkinsQuery = "SELECT * FROM Skins WHERE s.tipo = 0"
#showBoardSkinsQuery = "SELECT * FROM Skins WHERE s.tipo = 1"
...
buySkinQuery = "SELECT * FROM Skins s, Usuarios us, Tiene t WHERE (" + checkStateSkinQuery + ") AND s.precio <= us.puntos AND s.skinId = %s"
